...
search = '''        document.getElementById('timelineSlider').addEventListener('input', (e) => {
...
replace = '''        async function loadFrontlineLayersForDate(date) {
            const promises = [];
...
if search in content:
    ...
    with open('static/js/map-layers.js', 'w') as f:
        f.write(content)
    print("Successfully patched timelineSlider")
else:
    print("timelineSlider search string not found")
